...
End clients can only fetch necessary data via REST API requests and backend application provides appropriate data to the clients.
...
In other words, the frontend of an application or website should be intuitive and easy to use.
