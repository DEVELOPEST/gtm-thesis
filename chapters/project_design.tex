...
Back-end application was built with Rust using Rocket framework.
...
Back-end code base is built following DDD because it helps to keep application maintainable, extendable and organized.
