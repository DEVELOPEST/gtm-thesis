...
\begin{table}[h]
    ...
    \begin{tabular}{ | p{4cm} | p{4cm} | p{4cm} |}
        ...
        \hline
        GET /commits/hash & provider: string, user: string, repo: string & Returns last commit hash\\ % TODO TAVO vaata see ule ja kas on midagi lisada
        \hline
    \end{tabular}
...
\begin{table}[h]
    ...
    \begin{tabular}{ | p{4cm} | p{4cm} | p{4cm} |}
        ...
        \hline
        GET /\{group\_name\}/subdirs-timeline & start: int, end: int, interval: string, timezone: string & Returns sub-directory timeline for group. \\
        \hline
...
Time period has start and end which cannot be apart more than a year.
