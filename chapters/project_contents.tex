...
This can be done both only locally or with pushing and pulling notes from remotes. %TODO vaata see üle, jube segane
...
Firstly, to have the sync client access the data, you cannot have time data only stored locally. %TODO Lappab imo taiega :D
...
The security of source code stored in a Git repository is handled by a client himself and Git providers. %TODO himself/themselves?
...
User can choose between all the groups he has access to. %TODO he has access/they have access
The time period has start and end which cannot be apart more than a year for performance reasons. %TODO sonastus
...
We would like someone to base his closed source (and potentially non-free) application on gtm-sync. %TODO his/their
...
If someone wishes to use it without open sourcing his code, there is always an option to ask us as dual licensing is also a possibility. %TODO his/their?
