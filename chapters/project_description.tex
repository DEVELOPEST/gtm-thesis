...
\begin{itemize}
    ...
    \item The time tracking application has to work with repositories containing tens thousands of commits.
...
It is very important to protect source code, therefore they highly prefer the code to never leave their own hardware.
...
remain working efficiently when used in repositories containing a big number of commits.
...
Trying to record internet browsing data or time spent on other programs may be seen as invasion of privacy, and it might greatly reduce the amount of users interested in our app.