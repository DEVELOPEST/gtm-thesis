...
\newcommand{\doctitleeesti}{Programmeerimisele kuluva aja jälgimise ja visualiseerimise süsteemi arendamine}
\newcommand{\docsubtitle}{Bachelor Thesis}
\newcommand{\docsubtitleeesti}{Bakalaureusetöö}
...
\newcommand{\universityeesti}{TALLINNA TEHNIKAÜLIKOOL}
\newcommand{\school}{School of Information Technologies}
\newcommand{\schooleesti}{Infotehnoloogia teaduskond}
\newcommand{\department}{Department of Software Science}
\newcommand{\departmenteesti}{Department of Software Science}
...
\begin{document}
    ...
    \input{appendices/appendix-project-links.tex}
    ...
    \input{appendices/appendix-frontend-viws.tex}
